...
def build_FAMILIES():
    ...
    return [
        ...
        (["G1", "G2", "G3", "G4", "G5", "G7b"], [n%2==0, m%3==0, (m-2*n)%4==0, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G13"], [n%2==0, m%3==0, (m-2*n)%4==1, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G14"], [n%2==0, m%3==0, (m-2*n)%4==2, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G12"], [n%2==0, m%3==0, (m-2*n)%4==3, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G8", "G10"], [n%2==0, m%3==1, (m-2*n)%4==0, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G8", "G10", "G13"], [n%2==0, m%3==1, (m-2*n)%4==1, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G8", "G10", "G14"], [n%2==0, m%3==1, (m-2*n)%4==2, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G8", "G10", "G12"], [n%2==0, m%3==1, (m-2*n)%4==3, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G9", "G11"], [n%2==0, m%3==2, (m-2*n)%4==0, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G9", "G11", "G13"], [n%2==0, m%3==2, (m-2*n)%4==1, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G9", "G11", "G14"], [n%2==0, m%3==2, (m-2*n)%4==2, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G7b", "G9", "G11", "G12"], [n%2==0, m%3==2, (m-2*n)%4==3, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6"], [n%2==1, m%3==0, (m-2*n)%4==0, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G13"], [n%2==1, m%3==0, (m-2*n)%4==1, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G14"], [n%2==1, m%3==0, (m-2*n)%4==2, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G12"], [n%2==1, m%3==0, (m-2*n)%4==3, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G8", "G10"], [n%2==1, m%3==1, (m-2*n)%4==0, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G8", "G10", "G13"], [n%2==1, m%3==1, (m-2*n)%4==1, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G8", "G10", "G14"], [n%2==1, m%3==1, (m-2*n)%4==2, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G8", "G10", "G12"], [n%2==1, m%3==1, (m-2*n)%4==3, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G9", "G11"], [n%2==1, m%3==2, (m-2*n)%4==0, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G9", "G11", "G13"], [n%2==1, m%3==2, (m-2*n)%4==1, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G9", "G11", "G14"], [n%2==1, m%3==2, (m-2*n)%4==2, n+1 < m, 5*m < 6*n-3]),
        (["G1", "G2", "G3", "G4", "G5", "G6", "G9", "G11", "G12"], [n%2==1, m%3==2, (m-2*n)%4==3, n+1 < m, 5*m < 6*n-3]),

        (["G1", "G2", "G3", "G4", "G7b", "G13"], [n%2==0, m%3==0,6*n-3<=5*m,5*m<6*n]),
        (["G1", "G2", "G3", "G4", "G7b", "G8", "G12"], [n%2==0, m%3==1,6*n-3<=5*m,5*m<6*n]),
        (["G1", "G2", "G3", "G4", "G7b", "G9", "G14"], [n%2==0, m%3==2,6*n-3<=5*m,5*m<6*n]),
        (["G1", "G2", "G3", "G4", "G6", "G13"], [n%2==1, m%3==0,6*n-3<=5*m,5*m<6*n]),
        (["G1", "G2", "G3", "G4", "G6", "G8", "G12"], [n%2==1, m%3==1,6*n-3<=5*m,5*m<6*n]),
        (["G1", "G2", "G3", "G4", "G6", "G9", "G14"], [n%2==1, m%3==2,6*n-3<=5*m,5*m<6*n]),
        ...
        (["G1", "G2", "G3", "G6"], [m%3==0,3*n<=2*m+4]),
        (["G1", "G2", "G3", "G7b", "G8"], [m%3==1,3*n<=2*m+4]),
        (["G1", "G2", "G3", "G6", "G9"], [m%3==2,3*n<=2*m+4]),
    ]
